...
public class KeggRestService {
	...
	public static void main(String[] args) {
		Vector<String> cids = KEGGbySumFormula("C7H10O5");
		Vector<IAtomContainer> cons = new Vector<IAtomContainer>();
		SmilesGenerator sg = new SmilesGenerator();
		
		Vector<IAtomContainer> mols = getMolsOnline(cids);
		for(int i = 0; i < mols.size(); i++) {
			System.out.println(cids.get(i));
			System.out.println(sg.createSMILES(mols.get(i)));
		}
	}
